...
export const DEMO_CLUBS: DemoClub[] = [
  {
    id: 'demo-1',
    name: '버디 배드민턴 클럽🔥신입모집🔥',
    description: `함께 성장하는 2030 배드민턴 모임! 🏸
#분위기좋은모임 #초보환영 #여성친화

🤍 관악구 배드민턴 연합 — 버디민턴 소속 🤍
⭐ insta: @buddy_badminton ⭐

🟥 가입문의 (📩 2026년 연회비 15,000원)
✔ 회비 확인 후 가입인사 작성 & 연회비 납부
⭐ 연회비 입금 계좌 ⭐
카카오뱅크 3333-36-XXXXXXX 김민준

🟥 가입조건
✔ 나이 : 20~30대 (지인추천 제외)
✔ 급수 : 왕초보 ~ D조 환영 (자강은 운영진 사전 협의)
...
🟥 개인 준비물
✔ 라켓, 실내 배드민턴화, 셔틀콕 ⭐3⭐ 2개
✔ 공인구 : 삼화 더블백, kbb79, 삼화900

💖 콕플 정기 뒷풀이 및 회식 💖
- 매월 1회 정기적으로 진행 중

👀 그 외 세부사항은 가입 후 문의해주세요~`,
    court_count: 3,
