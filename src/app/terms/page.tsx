        ...
        <div className="space-y-10 text-[0.95rem] text-[#333] leading-[1.9]">
          ...
          <Section title="제6조 (정기결제 자동 갱신)">
            <ol className="list-decimal pl-5 space-y-2">
              ...
              <li>가격 인상이 발생하는 경우, 회사는 변경 적용 30일 전 이메일·앱 내 알림 등으로 회원에게 통보하고, 회원의 동의를 받습니다.</li>
          ...
          <Section title="제7조 (구독 해지)">
            <ol className="list-decimal pl-5 space-y-2">
              ...
              <li>해지 신청 시점부터 다음 결제는 청구되지 않으며, 이미 결제하신 기간이 끝날 때까지는 유료 기능을 그대로 이용하실 수 있습니다.</li>
              <li>해지 후 결제 정보(빌링키)는 즉시 또는 결제 주기 종료 시점에 폐기됩니다.</li>
            </ol>
          </Section>
          ...
          <Section title="제8조 (결제 실패 처리)">
            <ol className="list-decimal pl-5 space-y-2">
              ...
              <li>10일이 지나도 결제가 완료되지 않으면 자동으로 Free 플랜으로 변경되며, 기존 데이터는 그대로 유지됩니다.</li>
            </ol>
          </Section>
