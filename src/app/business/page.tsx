      ...
      <div className="max-w-2xl mx-auto px-5 py-14">
        ...
        <div className="bg-[#f8f8f8] rounded-2xl p-6 mb-10">
          ...
          <div className="text-[0.88rem] text-[#555] leading-[1.85] space-y-2">
            <p>
              버디민턴 Pro / Team 정기결제 서비스는 전자상거래 등에서의 소비자보호에 관한 법률 제17조에 따라 청약철회 규정이 적용됩니다.
            </p>
            <p>
              <strong className="text-[#111]">청약철회 가능 조건:</strong> 서비스 이용 이력이 없는 경우, 결제일로부터 7일 이내
            </p>
            <p>
              <strong className="text-[#111]">청약철회 제한 조건:</strong> 결제 후 유료 기능 사용을 시작한 경우 (전자상거래법 제17조 제2항 제5호 — 디지털 서비스 이용 개시)
            </p>
            <p>
              구독 해지는 마이페이지에서 언제든 가능하며, 해지 시 다음 결제 주기부터 청구가 중단됩니다.
            </p>
            <p>
