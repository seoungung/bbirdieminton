...
import { ChevronRight, Users, UserPlus, Wallet, Trophy, FileDown, Gamepad2 } from 'lucide-react'
...
const FEATURES: { Icon: IconComp; label: string; description: string; href: (id: string) => string }[] = [
  {
    Icon: Users,
    label: '회원 관리',
