...
export const metadata: Metadata = {
  title: '환불정책',
  description: '버디민턴 Pro / Team 정기결제 환불 정책 안내',
}
        ...
        <section className="space-y-8 text-[15px] text-[#333] leading-[1.8]">
          ...
          <div>
            ...
            <ul className="list-disc pl-6 space-y-1.5">
              ...
              <li>유료 기능 사용을 이미 시작한 경우 (디지털 서비스 성격상 부분 환불 불가)</li>
              <li>단순 변심으로 인한 환불 요청이 반복되는 경우</li>
            </ul>
            <p className="mt-3 text-[13px] text-[#777]">
              * 서비스가 광고/설명과 현저히 다르거나 결제 시스템 오류 등 당사 귀책으로 인한
              문제는 사용 여부와 무관하게 전액 환불합니다.
            </p>
          </div>

          <div>
            <h2 className="text-[18px] font-bold text-[#111] mb-3">3. 구독 해지</h2>
            <p className="mb-3">
              마이페이지의 결제 관리에서 언제든 구독을 해지하실 수 있습니다.
            </p>
            <ul className="list-disc pl-6 space-y-1.5">
              <li>해지 시점부터 <strong>다음 결제 주기 청구가 중단</strong>됩니다.</li>
              <li>이미 결제된 기간 동안은 유료 기능이 계속 제공됩니다.</li>
              <li>잔여 기간에 대한 일할 환불은 제공되지 않습니다 (위 1항 조건 충족 시는 예외).</li>
            </ul>
          </div>

          <div>
            <h2 className="text-[18px] font-bold text-[#111] mb-3">4. 환불 요청 방법</h2>
            <ol className="list-decimal pl-6 space-y-1.5">
              <li>
                이메일 <a href="mailto:hello@birdieminton.com" className="underline text-[#111] font-semibold">hello@birdieminton.com</a>으로
                <strong> 가입 이메일 + 결제일 + 환불 사유</strong>를 보내주세요.
              </li>
              <li>영업일 기준 1~3일 이내 환불 가능 여부를 회신해 드립니다.</li>
              <li>승인 시 결제하신 카드로 승인취소 처리됩니다.</li>
            </ol>
          </div>

          <div>
            <h2 className="text-[18px] font-bold text-[#111] mb-3">5. 환불 처리 기간</h2>
            <ul className="list-disc pl-6 space-y-1.5">
          ...
          <div>
            <h2 className="text-[18px] font-bold text-[#111] mb-3">6. 판매자 정보</h2>
            <div className="bg-[#f8f8f8] rounded-xl p-5 text-[14px] leading-[1.8]">
              ...
              <p><strong>이메일:</strong> hello@birdieminton.com</p>
            </div>
          </div>
        </section>
      </div>
