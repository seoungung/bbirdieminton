...
import { Copy, LogOut, Trash2, MessageCircle } from 'lucide-react'
import type { Club } from '@/types/club'
import { regenerateInviteCodeAction } from '@/app/club/[clubId]/members/actions'
 ...
 *   1) 초대코드 (전체)
 *   2) 모임 프로필 (manager)
 *   3) 게임 규칙 — 21/25 점 듀스 (manager)
 *   4) 위험 영역 — 모임 나가기 (non-owner) / 모임 삭제 (owner)
 *
 * 기존 SettingsClient 의 섹션 1/3/4/6 을 그대로 옮긴 것 — 로직 변경 0.
 */
export function SettingsClubInfoClient({ club, isOwner, isManager }: Props) {
