...
const PLANS: Plan[] = [
  ...
  },
  {
    ...
    features: [
      ...
      '공동 관리자(Co-admin) 최대 3명 지정',
      '치명적 기능: 미납자 자동 리마인드 카톡 알림톡',
      '치명적 기능: 정기 일정 빈자리 대기열 자동 충원',
  ...
  },
  {
    ...
    features: [
      ...
      '공동 관리자 무제한 지정',
      '치명적 기능: 정산 · 출석 · 재무 데이터 Excel 추출',
      '치명적 기능: 연말 · 총회용 PDF 보고서 자동 생성',
      '고급 통계 dashboard',
      '분기 · 연간 종합 리포트 PDF',
      '우선 지원 (카톡 1:1 채널)',
    ],
...
const FAQS = [
  ...
  {
    q: '구독은 어떻게 해지하나요?',
    a: '언제든 마이페이지의 결제 관리 메뉴에서 해지하거나, 이메일(hello@birdieminton.com)로 신청하실 수 있습니다. 해지 시 다음 결제는 청구되지 않으며, 이미 결제된 기간 종료 시점까지는 유료 기능을 그대로 이용하실 수 있습니다.',
  },
  {
    q: '환불은 어떻게 되나요?',
  ...
  {
    q: '플랜을 언제든 변경할 수 있나요?',
    a: '네. 업그레이드는 즉시 적용되고 차액만 청구됩니다. 다운그레이드는 다음 결제 주기부터 적용되며, 강등되어도 기존 데이터는 그대로 유지됩니다. 단, 멤버 수 한도를 초과한 상태에서는 신규 정기 일정 개설이 제한됩니다.',
  },
  {
    q: '결제는 어떤 방법으로 가능한가요?',
    a: '신용 · 체크카드 정기결제(빌링)를 지원합니다. 토스페이먼츠 통합 결제로 안전하게 진행되며, 카드 정보는 토스페이먼츠에 안전하게 보관됩니다.',
  },
  {
    q: '가격이 인상되면 어떻게 되나요?',
    a: '전자상거래법에 따라 가격 인상이 발생하는 경우, 회사는 변경 적용 30일 전 이메일 · 앱 내 알림 등으로 회원에게 통보하고 명시적 동의를 받습니다. 동의하지 않으시면 기존 가격으로 다음 결제 주기까지 이용 가능합니다.',
  },
  {
    q: '결제가 실패하면 어떻게 되나요?',
    a: '정기결제 실패 시 최대 10일 동안 재시도 및 회원 안내를 진행합니다. 10일 이후에도 결제가 완료되지 않으면 자동으로 Free 플랜으로 다운그레이드되며, 기존 데이터는 그대로 유지됩니다. 카드 정보를 업데이트하시면 언제든 다시 유료 플랜으로 복귀하실 수 있습니다.',
  },
  {
    ...
    <main className="bg-[#0a0a0a] text-white min-h-screen">
      ...
      <section className="px-8 py-20 sm:py-28 border-b border-white/10">
        <div className="max-w-[1200px] mx-auto text-center">
          ...
          <p className="text-lg text-white/60 max-w-[560px] mx-auto leading-relaxed mb-10">
            v2.0 베타 기간(1~3개월) 동안 Basic · Pro 모든 기능 무료.<br />
      ...
      <section className="px-8 py-20">
        ...
        <p className="text-center text-[12px] text-white/45 mt-4 max-w-[760px] mx-auto leading-relaxed">
          멤버 수 한도 초과 시 신규 가입 신청이 자동 차단되며, 다운그레이드 시 기존 데이터는 유지되지만 한도 초과 상태에서는 새로운 정기 일정 개설이 제한됩니다.
        </p>
      </section>
